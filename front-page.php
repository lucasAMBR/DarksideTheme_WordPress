...
<section>
    <div class="text-gray-300 p-6 px-12">
        ...
        <div class="flex lg:flex-row-reverse md:flex-col-reverse flex-col-reverse items-center">
    ...
    <section class="text-white">
        <h2 class="text-center text-3xl lg:text-5xl font-bold mb-4">Nossos Serviços</h2>
        <div class="text-gray-300 p-6 px-12 flex flex-col lg:flex-row justify-between items-center items-stretch">
